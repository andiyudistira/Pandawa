...
namespace Siska.Data.Dao 
{
    public partial class BsContext : BrightstarEntityContext {
    	...
    	static BsContext() 
    	{
    		...
    		provider.AddMappingsForType(TypeMappings, typeof(Siska.Data.Model.Auth.IRole));
    		TypeMappings.AddImplMapping<Siska.Data.Model.Auth.IRole, Siska.Data.Model.Auth.Role>();
    		provider.AddMappingsForType(TypeMappings, typeof(Siska.Data.Model.Auth.IUser));
    	...
    	public IEntitySet<Siska.Data.Model.Auth.IUser> Users
    	{
    		get; private set;
    	}
...
namespace Siska.Data.Model.Auth 
{
    ...
    public partial class Role : BrightstarEntityObject, IRole 
    {
    	...
    	#region Implementation of Siska.Data.Model.Auth.IRole
    
    	public Siska.Data.Model.Auth.IUser InsertBy
    	{
            get { return GetRelatedObject<Siska.Data.Model.Auth.IUser>("InsertBy"); }
            set { SetRelatedObject<Siska.Data.Model.Auth.IUser>("InsertBy", value); }
    	}
    	...
    	public Siska.Data.Model.Auth.IUser UpdateBy
    	{
            get { return GetRelatedObject<Siska.Data.Model.Auth.IUser>("UpdateBy"); }
            set { SetRelatedObject<Siska.Data.Model.Auth.IUser>("UpdateBy", value); }
    	}
    	...
    	public System.Collections.Generic.ICollection<Siska.Data.Model.Auth.IUser> Users
    	{
    		get { return GetRelatedObjects<Siska.Data.Model.Auth.IUser>("Users"); }
...
namespace Siska.Data.Model.Auth 
{
    ...
    public partial class User : BrightstarEntityObject, IUser 
    {
    	...
    	public User() : base() { }
    	public System.String Id { get {return GetIdentity(); } set { SetIdentity(value); } }
    	#region Implementation of Siska.Data.Model.Auth.IUser
    	...
    	public System.Collections.Generic.ICollection<Siska.Data.Model.Auth.IRole> Roles
    	{
    		get { return GetRelatedObjects<Siska.Data.Model.Auth.IRole>("Roles"); }
    	...
    	public System.Collections.Generic.ICollection<Siska.Data.Model.Auth.IUserSession> UserSessions
    	{
    		get { return GetRelatedObjects<Siska.Data.Model.Auth.IUserSession>("UserSessions"); }
...
namespace Siska.Data.Model.Auth 
{
    ...
    public partial class UserSession : BrightstarEntityObject, IUserSession 
    {
    	...
    	public System.String Id { get {return GetIdentity(); } set { SetIdentity(value); } }
    	#region Implementation of Siska.Data.Model.Auth.IUserSession
    	...
    	public Siska.Data.Model.Auth.IUser User
    	{
            get { return GetRelatedObject<Siska.Data.Model.Auth.IUser>("User"); }
            set { SetRelatedObject<Siska.Data.Model.Auth.IUser>("User", value); }
    	}
